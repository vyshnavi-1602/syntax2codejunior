...
import { SessionProvider } from "@/client/lib/session";
  ...
  head: () => ({
    meta: [
      ...
      { title: "Syntax2Code — AI & Coding Platform for Schools" },
      {
        name: "description",
        content:
          "Syntax2Code: AI and coding curriculum, labs, competitions and analytics for schools.",
      },
      { name: "author", content: "Syntax2Code" },
