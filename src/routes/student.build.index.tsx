...
import { getStudentProjectsFn } from "@/server/api/student";
          ...
          <button
            onClick={() =>
              toast.success("New project started", {
                description: "Pick a brief from the gallery to begin your milestones.",
              })
            }
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          {list.map((p) => (
            ...
            >
              ...
              <p className="mt-1 line-clamp-2 text-xs leading-relaxed text-slate-500">{p.brief}</p>
